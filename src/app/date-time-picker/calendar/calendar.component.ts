...
export class CalendarComponent<D> implements AfterContentInit, OnDestroy {
    private privateIntlChanges: Subscription;
    ...
    constructor(private _elementRef: ElementRef, private _intl: DatepickerIntlService, private _ngZone: NgZone, @Optional() private _dateAdapter: DateAdapter<D>, @Optional() @Inject(MAT_DATE_FORMATS) private _dateFormats: any, changeDetectorRef: ChangeDetectorRef) {
        ...
        this.privateIntlChanges = merge(_intl.changes, this._dateFormats._getChanges).subscribe(() => {
    ...
    ngOnDestroy() {
        this.privateIntlChanges.unsubscribe();
    }
    ...
    private _handleCalendarBodyKeydownInMonthView(event: KeyboardEvent): void {
        switch (event.keyCode) {
            ...
            case PAGE_DOWN:
                ...
                break;
            case ENTER:
                if (this.dateFilterForViews(this._activeDate)) {
