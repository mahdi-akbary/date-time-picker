...
import {MatCalendarCell} from '../calendar-body/calendar-body.component';
...
@Component({
    moduleId: module.id,
    selector: 'npa-mat-month-view',
    templateUrl: 'month-view.component.html',
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class MonthViewComponent<D> implements AfterContentInit, OnDestroy {
        ...
        for (let i = 0, cell = this._firstWeekOffset; i < daysInMonth; i++, cell++) {
            ...
            if (this.lang == 'en') {
                this._weeks[this._weeks.length - 1]
                    .push(new MatCalendarCell(i + 1, dateNames[i], ariaLabel, enabled, dateFa));
            } else {
                this._weeks[this._weeks.length - 1]
                    .push(new MatCalendarCell(i + 1, dateNames[i], ariaLabel, enabled, dateEn));
            }
