...
import {MD_DATEPICKER_SCROLL_STRATEGY_PROVIDER, NpaMatDatepickerComponent} from './npa-mat-datepicker.component';
...
import {MdDatepickerIntl} from '@angular-persian/material-date-picker';
...
export * from './npa-mat-datepicker.component';
...
export class NpaMatDatepickerModule {
}
